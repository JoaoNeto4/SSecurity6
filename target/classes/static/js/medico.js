...
$(function() {
	...
	//extrai ultimo termo adicionado
	...
	//mostra na pagina um toast com menssagem de especialidades repetidas
    function exibeMessagem(texto) {
        $('.add-toast').append(""
          .concat('<div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="3100">',

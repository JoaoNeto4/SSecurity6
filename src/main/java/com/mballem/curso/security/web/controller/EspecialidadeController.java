...
public class EspecialidadeController {
	...
	public ResponseEntity<?> getEspecialidades(HttpServletRequest request) {
		...
		/* Returns our Map object for the page, which will be transformed 
		   by the jackson object library into json, which will be sent to the javascript table.
		*/
	...
	public ResponseEntity<?> getEspecialidadesPorTermo(@RequestParam("termo") String termo) {
		...
		List<String> especialidades = service.buscarEspecilaidadeByTermo(termo);

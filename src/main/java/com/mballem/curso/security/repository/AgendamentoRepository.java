...
public interface AgendamentoRepository extends JpaRepository<Agendamento, Long>{
	...
	List<Horario> findByMedicoAndDataNotHorarioAgendado(Long id, LocalDate data);

	/*
	 * similar ao padrão DTO, para Spring DataJPA usamos uma interface com os 
	 * valores de retorno definidos a partir de metodos get() do tipo referente 
	 * ao que esta retornando.
	 * ver "HistoricoPaciente"
	 */
	...
	Optional<Agendamento> findAllByIdAndPacienteOrMedicoEmail(Long id, String email);
